 ...
 */
$_['heading_title'] = 'EMS PAY: Creditcard';
$_['text_emspay_cc'] = '<img src="view/image/payment/emspay_creditcard.png" alt="EMS PAY" title="EMS PAY" />';
...
$_['text_settings_saved'] = 'EMS PAY: Credit Card instellingen bijgewerkt!';
$_['text_edit_ems'] = 'Bewerken EMS PAY: Credit Card instellingen';
$_['text_yes'] = 'Ja';
$_['text_no'] = 'Nee';
 ...
 * Error messages
 */
$_['error_missing_api_key'] = 'EMS PAY API Key is verplicht!';

/**
 * Information text
 */
$_['info_help_api_key'] = 'Kopieer uw EMS PAY API key van uw merchant portal.';
$_['info_help_total'] = 'De betaalmethode wordt alleen getoond als het totaalbedrag van een bestelling hoger is dan dit bedrag.';
$_['info_plugin_not_configured'] = 'EMS PAY: Credit Card plugin is niet ingesteld.';
$_['info_help_klarna_ip_filter'] = 'Indien ingevoerd, alleen voor die IPs, wordt de betaalmethode weergegeven. (Bijvoorbeeld: 128.0.0.1, 255.255.255.255)';
